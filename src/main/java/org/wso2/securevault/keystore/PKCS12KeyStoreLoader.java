...
public class PKCS12KeyStoreLoader extends AbstractKeyStoreLoader {
    ...
    public KeyStore getKeyStore() {
        ...
        if (provider != null) {
            return getKeyStore(keyStorePath, keyStorePassword, Constants.PKCS12, provider);
        }
        return getKeyStore(keyStorePath, keyStorePassword, Constants.PKCS12, Constants.SUN_JSSE);
    }
}
