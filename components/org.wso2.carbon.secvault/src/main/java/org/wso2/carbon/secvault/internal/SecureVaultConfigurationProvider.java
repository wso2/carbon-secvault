...
public class SecureVaultConfigurationProvider {
     ...
     */
    public void initSecureVaultConfig(Path secureVaultConfigurationPath) throws SecureVaultException {
        if (secureVaultConfiguration != null) {
            secureVaultConfiguration = SecureVaultUtils.getSecureVaultConfig(secureVaultConfigurationPath)
     ...
     * @throws SecureVaultException when error occurs in secure vault configuration provider initialisation
     */
    public Optional<SecureVaultConfiguration> getConfiguration() throws SecureVaultException {
